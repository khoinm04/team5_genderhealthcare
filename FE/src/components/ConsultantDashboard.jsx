    ...
    const DashboardOverview = () => (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">Lượt xem blog</h3>
                    <p className="text-3xl font-bold text-blue-600">{consultantStats.blogViews.toLocaleString()}</p>
                </div>

                <div className="bg-white p-6 rounded-lg shadow-md">
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">Doanh thu tháng</h3>
                    <p className="text-3xl font-bold text-indigo-600">{consultantStats.monthlyRevenue.toLocaleString()} VND</p>
                </div>
            </div>
