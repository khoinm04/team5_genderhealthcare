    ...
    <>
      ...
      <div className="flex gap-6 items-center justify-center mt-6">
        <button
          ...
          className="min-w-[150px] px-8 py-3 rounded-full bg-gradient-to-r from-pink-500 to-pink-400 text-white font-semibold text-base shadow hover:from-pink-600 hover:to-pink-500 transition-all"
        >
          Tiếp Tục
        </button>
        <button
          onClick={() => setIsOpen(false)}
          className="min-w-[110px] px-8 py-3 rounded-full border border-gray-300 text-gray-700 font-semibold text-base bg-white transition-colors duration-200 hover:text-pink-500">
          Đóng
        </button>
